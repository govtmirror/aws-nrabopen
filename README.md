...
`http://localhost:8080/components/aws-nrabopen/`, where `aws-nrabopen` is the name of the directory containing it.


## Testing Your Element

Simply navigate to the `/test` directory of your element to run its tests. If
you are using Polyserve: `http://localhost:8080/components/aws-nrabopen/test/`
